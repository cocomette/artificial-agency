...
sequenceDiagram
    ...
    Orch->>MemRole: sanitized action/change/reward ledger + first/current frames
    ...
    Orch->>Orch: compute proxy LP reward and append finalized ledger entry
    Orch->>MemRole: sanitized action/change/reward ledger + current frame
