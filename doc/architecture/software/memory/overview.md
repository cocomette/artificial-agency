...
context, turn metrics, metadata, solved-level compacter summaries, and
timestamps. It no longer stores visual forecast artifacts. Existing local run
databases using the older table shape are incompatible and should be reset.
