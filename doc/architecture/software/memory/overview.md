...
- `M` state memory for committed frame turns and agent context.
...
predictions, rewards, and model-input debug records. Existing local run
databases using older table shapes are incompatible and should be reset.
