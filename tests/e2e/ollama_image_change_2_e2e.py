...
IMAGE_2_BBOX_SCHEMA: dict[str, Any] = {
    ...
    "properties": {
        "x0": {"type": "number", "description": "Top-left visual x coordinate."},
        "y0": {"type": "number", "description": "Top-left visual y coordinate."},
        "x1": {
            "type": "number",
            "description": "Bottom-right visual x coordinate.",
        },
        "y1": {
            "type": "number",
            "description": "Bottom-right visual y coordinate.",
        },
    },
...
def _prompt_text(
    ...
    *,
    ...
    return (
        ...
        "Image 1 is supplied only as JSON description items. Each item has a stable id, pixel bbox_2d array [x0, y0, x1, y1], and text description.\n"
