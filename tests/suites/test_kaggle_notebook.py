...
def test_kaggle_debug_kernel_identity_uses_branch_and_commit() -> None:
    ...
    assert kernel_id == (
        "kaggle-owner/foa-arc3-rtx6000-debug-feat-2-model-setup-5109ce7b"
    )
    assert title == "FOA ARC3 RTX6000 Debug feat-2-model-setup 5109ce7b"
...
def test_kaggle_debug_metadata_sync_generates_kernel_identity(
    ...
    assert synced["title"] == "FOA ARC3 RTX6000 Debug feat-2-model-setup 5109ce7b"
