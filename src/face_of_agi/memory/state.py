...
class StateMemory:
    ...
    def complete_frame_turn_state(
        ...
        *,
        ...
        if compacter_context is not None:
            metadata["compacter_context"] = compacter_context
        if extra_metadata:
    ...
    def write_compacter_level_summary(
        ...
        *,
        ...
        """Store one solved-level compacter summary."""

        return self.database.write_compacter_level_summary(
            run_id=run_id,
            game_id=game_id,
    ...
    def read_latest_compacter_level_summary(
        ...
        *,
        ...
        """Read the latest solved-level compacter summary."""

        return self.database.read_latest_compacter_level_summary(
            run_id=run_id,
            game_id=game_id,
        )
    ...
    def read_compacter_context_before(
        ...
        *,
        ...
        """Return the newest previous compacter context before a state row."""

        if before_state_id is None:
            return ""
        return self.database.read_compacter_context_before(
            game_id=game_id,
            state_id=before_state_id,
        )
    ...
    def merge_state_metadata(
        ...
        *,
        ...
        return self.database.merge_m_state_metadata(
            state_id=state_id,
            metadata=metadata,
        )
