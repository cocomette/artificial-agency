"""OpenAI provider for the historizer."""
...
class OpenAIHistorizerAdapter(HistorizerAdapter):
    """Historizer backed by OpenAI Responses."""
...
class OpenAIHistorizerProvider:
    ...
    def __init__(
        ...
        *,
        ...
        config.text = with_openai_historizer_text_format(config.text)
        self.config = config
    ...
    def summarize_history(
        ...
        return self._structured_response(request, phase="summarize_history")
    ...
    def _structured_response(
        ...
        *,
        ...
        response = self._client.create_response(
            ...
            text=with_openai_historizer_text_format(
                self.config.text,
    ...
    def _provider_response(
        ...
        return PromptHistorizerProviderResponse(
            text=output_text,
            metadata={**request.metadata, **response_metadata},
        )
