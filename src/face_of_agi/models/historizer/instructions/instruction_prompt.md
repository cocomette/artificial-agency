...
- `strategy_summary`: very compressed non-redundant summary of tried strategies, including successes and failures inferred from strategy evolution and action history. Keep this field under 1000 characters.
...
For `strategy_summary`:
- Summarize tried strategies across probing and policy together, emphasizing what was attempted, what succeeded, what failed, and which strategic assumptions changed.
- Keep it highly compressed and avoid repeating `probing_evolution`, `policy_evolution`, or individual action-history rows.
- Do not propose future actions.
