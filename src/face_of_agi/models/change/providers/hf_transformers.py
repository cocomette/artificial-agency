"""HF/Transformers provider for transition change summaries."""
...
class HFChangeSummaryProvider:
    """Final HF chat transport for transition change summaries."""
    ...
    def __init__(
        ...
        *,
        ...
        if not getattr(config, "model", None) and not getattr(config, "model_path", None):
            raise ValueError(
                "HF change summary requires an explicit model or model_path"
            )
        self.config = config
    ...
    def complete(
        ...
        *,
        ...
        """Call HF and return raw change summary JSON text."""
    ...
    def repair_complete(
        ...
        *,
        ...
        """Ask HF to repair invalid change summary JSON."""
...
__all__ = ["HFChangeSummaryProvider"]
