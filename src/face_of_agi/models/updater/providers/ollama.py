...
class OllamaUpdaterProvider:
    ...
    def __init__(
        ...
        *,
        ...
        config.format = updated_context_json_schema()
        self.config = config
    ...
    def update_prompt(
        ...
        with runtime_timing.span(
            ...
            response = self._client.chat(
                ...
                messages=messages,
                response_format=updated_context_json_schema(),
            )
        ...
        repair_text = "\n\n".join(
            [
                ...
                (
                    ...
                    "`updated_context` field. Its value must be a string "
                    "containing the complete revised context text, not an "
                    "object, array, `game` field, or `general` field."
                ),
            ]
        )
        return [
