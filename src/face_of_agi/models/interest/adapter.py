...
class VLLMInterestAdapter:
    ...
    def activate_lora_adapter(self, adapter_name: str) -> None:
        """Use a successfully loaded vLLM LoRA adapter for future Interest calls."""
    ...
    def score_candidates(
        ...
        metadata = {
            ...
            "training_schema_name": "interest_prediction",
...
class HFInterestAdapter:
    """Interest role backed by the shared HF/Transformers VLM."""

    def __init__(
        self,
        config: HFInterestConfig,
        *,
    ...
    def activate_lora_adapter(self, adapter_name: str) -> None:
        """Use a loaded HF LoRA adapter for future Interest calls."""
    ...
    def score_candidates(
        ...
        payload = hf_parse_json_object(text, label="interest")
        candidate_values = _parse_candidate_values(
            payload,
            prediction_input=prediction_input,
        )
