...
class DebugTrace:
    ...
    def emit(self, event: DebugEvent) -> None:
        ...
        if isinstance(event, RunStarted):
            ...
            self.agent_framework_input(
                ...
                world_game_context=event.world_game_context,
                goal_game_context=event.goal_game_context,
                first_observation=event.first_observation,
    ...
    def agent_framework_input(
        ...
        *,
        ...
        payload: dict[str, Any] = {
            ...
            "first_observation": _observation_payload(first_observation),
    ...
    def tool_model_input(
        ...
        *,
        ...
        """Print the framework-level S/G tool input."""
    ...
    def tool_provider_input(
        ...
        *,
        ...
        """Print captured provider prompt/request data for S/G predictions."""
    ...
    def post_decision_predictions(
        ...
        """Print S/G prediction summaries."""
